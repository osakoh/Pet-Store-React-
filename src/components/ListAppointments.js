                        ...
                        <div className="pet-info media-body">
                            <div className="pet-head d-flex">
                                <span className="pet-name"
                                    ...
                                    onBlur={
                                        e => this.props.updateApt('petName', e.target.innerText, item.aptId)
                                    }>{item.petName}</span>
                            ...
                            <div className="owner-name">
                                ...
                                <span
                                    contentEditable suppressContentEditableWarning
                                    onBlur={
                                        e => this.props.updateApt('ownerName', e.target.innerText, item.aptId)
                                    }>{item.ownerName}</span>
                            </div>
                            <div className="apt-notes"
                                contentEditable suppressContentEditableWarning
                                onBlur={
                                    e => this.props.updateApt('aptNotes', e.target.innerText, item.aptId)
                                }>{item.aptNotes}</div>
                        </div>
                    </div>
                ))}
